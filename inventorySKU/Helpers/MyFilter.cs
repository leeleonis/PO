...
namespace inventorySKU
{
    ...
    public class CompanyFilter
    {
        ...
        public string ShandowSuffix { get { return shandowSuffixField; } set { shandowSuffixField = !string.IsNullOrEmpty(value) ? value.Trim() : value; } }
        public Nullable<int> ParentID { get; set; }
        public Nullable<int> RelateID { get; set; }
        public string eBayAccountID { get { return eBayAccountIDField; } set { eBayAccountIDField = !string.IsNullOrEmpty(value) ? value.Trim() : value; } }
        public string AmazonAccountID { get { return amazonAccountIDField; } set { amazonAccountIDField = !string.IsNullOrEmpty(value) ? value.Trim() : value; } }
    }
